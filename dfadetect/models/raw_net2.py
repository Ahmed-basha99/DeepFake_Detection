...
class RawNet(nn.Module):
    def __init__(self, d_args, device):
        ...
        self.block6 = nn.Sequential(Residual_block(nb_filts = d_args['filts'][2]))
        self.block7 = nn.Sequential(Residual_block(nb_filts = d_args['filts'][2]))
        self.block8 = nn.Sequential(Residual_block(nb_filts = d_args['filts'][2]))
        self.block9 = nn.Sequential(Residual_block(nb_filts = d_args['filts'][2]))
